...
class PlayerContainer extends Phaser.GameObjects.Container {
    constructor(scene, x, y, key, frame, health, maxHealth, id, attackAudio) {
        ...
        this.body.setCollideWorldBounds(true); // stopping the player from leaving the physical world.
    ...
    update(cursors) {
        this.body.setVelocity(0); // if you don't reset the velocity first, the object will continue to move.
