class Map {
    ...
    createMap() {
        ...
        // add the tilset image to our map
        ...
        this.blockedLayer.setCollisionByExclusion([-1]); //? This method takes an array of tile indexes that we do not want to check for collisions. So if we want all tiles in that layer to check for collisions we just pass in a minus 1.
